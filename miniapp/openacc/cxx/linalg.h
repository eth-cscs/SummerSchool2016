...
namespace linalg
{
    ...
    // initialize temporary storage fields used by the cg solver I do this here
    // so that the fields are persistent between calls to the CG solver. This is
    // useful if we want to avoid malloc/free calls on the device for the
    // OpenACC implementation (feel free to suggest a better method for doing
    // this)
